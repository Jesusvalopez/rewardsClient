...
const CouponForm = ({ currentId, setCurrentId }) => {
  ...
  const coupon = useSelector((state) =>
    currentId ? state.coupons.find((coupon) => coupon._id === currentId) : null
  );
  ...
  const clear = () => {
    setCurrentId(null);
    setCouponData({ value: 0, user: "", expireDate: "" });
  };
    ...
    <div>
      <form action="" onSubmit={handleSubmit}>
        ...
        <input
          ...
          onChange={(e) =>
            setCouponData({ ...couponData, user: e.target.value })
          }
        />
        <br />
        ...
        <input
          ...
          onChange={(e) =>
            setCouponData({ ...couponData, expireDate: e.target.value })
          }
        />
