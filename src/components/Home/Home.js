    ...
    <>
                ...
                <div className="flex flex-wrap justify-center">
                  ...
                  <div className="w-full lg:w-4/12 px-4 lg:order-3 lg:text-right lg:self-center">
                    <div className="py-6 px-3 mt-32 sm:mt-0">
                      <button
                        onClick={logout}
                        className="bg-sticksyellow active:bg-pink-600 uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1"
                        type="button"
      ...
      <div className="container mx-auto mt-5 text-center">
        <div className="flex flex-wrap justify-center bg-gray-50">
          <div className="bg-sticksyellow  p-4 m-2">1</div>
          <div className="bg-gradient-to-r from-sticksyellow to-yellow-500 p-4 m-2 flex-1">
            2
          </div>
          <div className="bg-sticksyellow p-4 m-2">3</div>
        </div>
